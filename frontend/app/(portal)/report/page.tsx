...
const Report = () => {
	...
	var data2 = {
	x: ['11:00', '11:10', '11:20', '11:30', '11:40', '11:50' ,'12:00', '12:10', '12:20', '12:30', '12:40', '12:50', '13:00', '13:10', '13:20' ],
	y: [0.03, 0.15, 0.08, 0.15, 0.21, 0.25, 0.25, 0.29, 0.31, 0.40, 0.31, 0.2, 0.12, 0.05],
	type: 'scatter',
	hovertemplate: '<b>Time: </b>%{x}<br> </br> <b> Percent Delayed Vehicles: </b> %{y}',
	name: 'Delays',
	line :{
		color: '#3b82f6'
	}
	...
	const layout2 = {
	  ...
	  const data3 = {
		...
		textinfo: "label+percent",
		name: 'CO2',
		hovertemplate: '<b> Mode: </b>%{label} %{percent}<br> </br> <b> Emissions: </b>%{value} kg',
		hole: .6,
		domain: {column: 0},
		textposition: "outside",
		automargin: true,
